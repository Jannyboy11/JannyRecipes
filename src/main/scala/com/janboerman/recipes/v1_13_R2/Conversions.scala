...
import com.janboerman.recipes.Extensions.BukkitKey
import com.janboerman.recipes.{RecipesPlugin, api}
import com.janboerman.recipes.api.MaterialUtils._
import com.janboerman.recipes.api.recipe.{ArmorDyeRecipe, BannerAddPatternRecipe, BannerDuplicateRecipe, BookCloneRecipe, ComplexRecipe, CraftingRecipe, FireworkRocketRecipe, FireworkStarFadeRecipe, FireworkStarRecipe, MapCloneRecipe, MapExtendRecipe, Recipe, RecipeType, RepairItemRecipe, ShapedRecipe, ShapelessRecipe, ShieldDecorationRecipe, ShulkerBoxColorRecipe, SmeltingRecipe, TippedArrowRecipe, UnknownRecipeType, CraftingIngredient => ApiCraftingIngredient, FurnaceIngredient => ApiFurnaceIngredient}
import com.janboerman.recipes.v1_13_R2.Extensions.{NmsStack, _}
import com.janboerman.recipes.v1_13_R2.recipe._
import com.janboerman.recipes.v1_13_R2.recipe.bukkit._
import com.janboerman.recipes.v1_13_R2.recipe.janny._
import com.janboerman.recipes.v1_13_R2.recipe.wrapper._
...
object Conversions {
    ...
    def toNMSIngredient(craftingIngredient: ApiCraftingIngredient): CraftingIngredient = craftingIngredient match {
    ...
    def toNMSIngredient(furnaceIngredient: ApiFurnaceIngredient): FurnaceIngredient = furnaceIngredient match {
    ...
    def toNMSRecipe(janny: Recipe): IRecipe = {
        janny match {
            ...
            case jannyFurnace: api.recipe.FurnaceRecipe => JannyFurnaceToNMS(jannyFurnace)
    ...
    def toJannyRecipe(bukkit: org.bukkit.inventory.Recipe): Recipe = {
        bukkit match {
            ...
            case _ => new Recipe {
                ...
                override def getType(): RecipeType = UnknownRecipeType
            }
        }
    }
    ...
    def toBukkitRecipe(janny: Recipe): org.bukkit.inventory.Recipe = {
        janny match {
            ...
            case janny: ComplexRecipe => JannyComplexToBukkit(janny)    //should be unreachable
            ...
            case janny: api.recipe.FurnaceRecipe => JannyFurnaceToBukkit(janny)
