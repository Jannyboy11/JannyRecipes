...
import com.janboerman.recipes.v1_13_R2.recipe.{BetterFurnaceSerializer, BetterMapExtendRecipe, BetterShapedSerializer, BetterShapelessSerializer, BetterTippedArrowRecipe}
import com.janboerman.recipes.{JannyImplementation, RecipesPlugin}
...
import com.janboerman.recipes.v1_13_R2.gui.GuiFactory
...
object Impl extends JannyImplementation {
    ...
    override def tryInitialize(): Boolean = {
        ...
        try {
            ...
            true //why is assignment not an expression in Scala?! I was going to return the statement one line above
        } catch {
            case e: Throwable =>
                e.printStackTrace()
                false
