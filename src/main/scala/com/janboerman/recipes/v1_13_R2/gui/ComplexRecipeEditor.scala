...
import com.janboerman.recipes.api.gui.{ArmorDyeRecipeEditor, BannerAddPatternRecipeEditor, BannerDuplicateRecipeEditor, BookCloneRecipeEditor, FireworkRocketRecipeEditor, FireworkStarFadeRecipeEditor, FireworkStarRecipeEditor, MapCloneRecipeEditor, MapExtendRecipeEditor, RecipesMenu, RepairItemRecipeEditor, ShieldDecorationRecipeEditor, ShulkerBoxColorRecipeEditor, TippedArrowRecipeEditor}
import com.janboerman.recipes.api.recipe.{ArmorDyeRecipe, BannerAddPatternRecipe, BannerDuplicateRecipe, BookCloneRecipe, FireworkRocketRecipe, FireworkStarFadeRecipe, FireworkStarRecipe, MapCloneRecipe, MapExtendRecipe, RepairItemRecipe, ShieldDecorationRecipe, ShulkerBoxColorRecipe, TippedArrowRecipe}
