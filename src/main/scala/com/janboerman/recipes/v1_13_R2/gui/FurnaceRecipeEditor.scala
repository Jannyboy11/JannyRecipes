...
import com.janboerman.recipes.api.gui.{FurnaceRecipeEditor, RecipesMenu}
...
import com.janboerman.recipes.api.gui.FurnaceRecipeEditor._
import com.janboerman.recipes.api.gui.{FurnaceRecipeEditor, RecipesMenu}
import com.janboerman.recipes.api.recipe.FurnaceRecipe

import scala.collection.mutable

object FurnaceRecipeEditor {
    def apply(furnaceRecipe: recipe.FurnaceRecipe)(implicit recipesMenu: RecipesMenu[RecipesPlugin.type]): FurnaceRecipeEditor[RecipesPlugin.type] = {
...
class FurnaceRecipeContainer(id: Int, bukkitPlayer: CraftPlayer, bukkitInventory: CraftInventory)
    extends Container {
    import com.janboerman.recipes.v1_13_R2.Extensions.{NmsStack, NmsSlot}
