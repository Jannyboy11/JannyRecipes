...
import com.janboerman.recipes.api.recipe.{CraftingResult, ShapedRecipe, ShapelessRecipe}
import com.janboerman.recipes.v1_13_R2.Conversions.DummySerializer
...
import com.janboerman.recipes.v1_13_R2.Conversions._
import com.janboerman.recipes.v1_13_R2.Extensions.NmsRecipe.Group
import com.janboerman.recipes.v1_13_R2.Extensions.{NmsIngredient, NmsNonNullList, NmsStack}
import com.janboerman.recipes.v1_13_R2.recipe._
import com.janboerman.recipes.v1_13_R2.recipe.CraftingIngredient
import com.janboerman.recipes.v1_13_R2.recipe.bukkit.{JannyFurnaceToBukkit, JannyShapedToBukkit, JannyShapelessToBukkit}
...
object JannyFurnaceToNMS {
    def apply(janny: recipe.FurnaceRecipe): JannyFurnaceToNMS = new JannyFurnaceToNMS(janny)
    def unapply(jannyWrapped: JannyFurnaceToNMS): Option[recipe.FurnaceRecipe] = Some(jannyWrapped.janny)
}

class JannyFurnaceToNMS(override val janny: recipe.FurnaceRecipe) extends JannySmeltingToNMS(janny) {
...
object JannyFurnaceSerializer extends RecipeSerializer[JannyFurnaceToNMS] {
    ...
    import com.janboerman.recipes.v1_13_R2.Extensions.NmsRecipe
